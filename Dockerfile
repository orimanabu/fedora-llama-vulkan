...
#RUN dnf install -y dnf-plugins-core vulkan-loader
#
#ENV mesa_version=24.1.5
#RUN dnf copr enable -y slp/mesa-krunkit
#RUN dnf install -y mesa-vulkan-drivers-${mesa_version}

FROM registry.fedoraproject.org/fedora-minimal:40
RUN microdnf install -y vulkan-loader https://download.copr.fedorainfracloud.org/results/slp/mesa-krunkit/fedora-40-aarch64/07895967-mesa/mesa-vulkan-drivers-24.1.5-101.aarch64.rpm
